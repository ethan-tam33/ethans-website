...
const Main = () => {
    ...
    return (
        <section id="home" className="animate-fadeIn animation-delay-2 selection:bg-blue-100">
            <div className="flex flex-col text-center items-center justify-center my-10 py-16 sm:py-32 md:py-48 md:flex-row md:space-x-4 md:text-left">
                ...
                <div className="md:mt-2 md:w-3/5 animate-fadeIn animation-delay-4">
                    ...
                    <h2 className="font-mono mt-3">
                        ...
                        <div>
                            You can find my&nbsp;
                            <a className="font-semibold hover:bg-sky-100 transition ease-in-out duration-300 rounded-full" href={resumeLink} target="_blank">resume here</a>
                            .
                        </div>
                    </h2>
                </div>
